...
var m_lesson = new Array(
"20181009","201801010","201801011"
)

var f_lesson = new Array(
"20181010","201801011"
)
...
function calendar(y,m) {
   ...
   for(i in lunar_fes)
      ...
      if(solar_fes[i].match(/^(\d{2})(\d{2})([\s\*])(.+)$/))
		...
		/*for(i=0; i<m_lesson.length;i++){
	      if(m_lesson[i].match(/^(\d{4})(\d{2})(\d{2})$/))
	         if((Number(RegExp.$1)==y)&&(Number(RegExp.$2)==(m+1))) {
	         	this[Number(RegExp.$3)].color = '#FF5F07'
	         }
        }*/
		...
		if ((y==2018)&&((m+1)==9)) {
			this[2].color = '#FF5F07'
			this[3].color = '#FF5F07'
			this[28].color = '#000000'
			this[29].color = '#000000'
		} 
